...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@200..1000&family=Katibeh&display=swap" rel="stylesheet">
  ...
  font-style: normal;
    ...
    <link rel="stylesheet" href="{{asset('/css/mobnav.css')}}">
    ...
    <div id="aaa"
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div style="display: flex;flex-direction:row-reverse;align-items:center">
                ...
                height="50px" 
                class="block w-auto rounded-full"
                style="height: 50px">

                <a href="{{ url('/') }}" style="margin-left: 12px"
                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 hidden sm:inblock">
                    {{__('website.homepage')}}
                </a>
                ...
                @if (Route::has('login'))
                    <div class=" w-full hidden  sm:top-0 sm:right-0  text-right z-10 sm:flex justify-center" style="flex-direction: row-reverse">
                        <div  id="langb"
                            class="mt-3 relative inline-flex items-center p-3 text-sm font-medium text-center text-gray-600 dark:text-white bg-gray-300 rounded-lg hover:bg-gray-400 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800 w-[50px]"
                        ...
                        <div id="langs" class="absolute  not bg-slate-300 dark:bg-slate-500"
                                style="width: 200px;position:absolute;padding-top:0;transform:translate(50px,40px)">
                            </div>
                        <div id="regs" style="padding:0">
                            @auth
                                <a href="{{ url('/dashboard') }}"
                                    class="font-semibold text-gray-600 hover:text-gray-900 dark:ext-white dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                                    {{__('website.dashboard')}}
                                </a>
                            @else
                                <a href="{{ route('login') }}" style="margin-left: 12px;"
                                ...
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}"
                                        class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                                        {{__('website.register')}}
                                    </a>
                                @endif
                            @endauth
                        </div>
                        <div id="regmob" href="#"><span class="spn"
                            ...
                            <div id="regmobcon" class="dontshow"
                                ...
                                @auth
                                    <a href="{{ url('/dashboard') }}"
                                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">{{__('website.dashboard')}}</a>
                                @else
                                    <a href="{{ route('login') }}"
                                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">{{__('website.login')}}
                                        </a>

                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}"
                                            class="font-semibold text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">{{__('website.register')}}</a>
                                    @endif
                                @endauth
                            </div>
                        </div>
            ...
            <div style="display: flex;flex-direction:row;align-items:center">
                ...
                @if (Route::has('login'))
                    <div class=" w-full hidden  sm:top-0 sm:right-0  text-right z-10 sm:flex justify-center">
                        <div id="langb"
                            class="mt-3 relative inline-flex items-center p-3 text-sm font-medium text-center text-white dark:text-gray-400 bg-gray-300 rounded-lg hover:bg-gray-400 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800 w-[50px]"
                            style="margin-right:12px;margin-left:12px;">
                            @if (App::getLocale() == 'jp')
                                {{ __('website.jp') }}<span class="langspan"
                                    style="background-image: url('{{ asset('/imgs/jp.png') }}')"></span>
                        ...
                        <div id="regs" style="padding:0">
                            @auth
                                <a href="{{ url('/dashboard') }}"
                                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-text-white dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">{{__('website.dashboard')}}</a>
                            @else
                                <a href="{{ route('login') }}"
                                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                                    {{__('website.login')}}</a>
            ...
            @if (App::getLocale() == 'ar')
                <h1 style="margin-top: 150px;font-size:10vw;font-family: 'Cairo', sans-serif;" class="mt-16 text-center  animsh hidden dark:block" >مجموعة سوا</h1>
                <h1 style="margin-top: 150px;font-size:10vw;font-family: 'Cairo', sans-serif;" class="mt-16 text-center  animshb block dark:hidden">مجموعة سوا</h1>
            @else
                <h1 style="margin-top: 150px" class="mt-16 text-center  animsh hidden dark:block" style="font-size:10vw;">SAWAGROUP</h1>
                <h1 style="margin-top: 150px" class="mt-16 text-center  animshb block dark:hidden" style="font-size:10vw;">SAWAGROUP</h1>
            @endif
            ...
            <div class="p-6  sm:max-w-[200px] bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl text-center mx-auto"
                ...
                @if (App::getLocale() == 'ar')
                <p class="text-center text-gray-800 dark:text-gray-200 sm:max-w-20 " style="min-height: 110px;direction:rtl">
                    <span class="fpart text-gray-800 dark:text-gray-400"> SAWAGROUP </span><span
            ...
            <video width="80%" height="240" style="margin: auto;margin-top:12px" src="{{asset('/vid/Compv.mp4')}}" autoplay loop control  muted>
            ...
            <div class="mt-4">
                ...
                @if (App::getLocale() == 'ar')
                <h2 class="flip" style="text-align: center">
                    <span class="text-gray-800 dark:text-gray-400" style="--i:1;font-family: 'Cairo', sans-serif;">سوا</span>
                    <span class="text-gray-800 dark:text-gray-400" style="--i:2;font-family: 'Cairo', sans-serif;">ل</span>
                    <span class="text-gray-800 dark:text-gray-400" style="--i:3;font-family: 'Cairo', sans-serif;">حو</span>
                </h2>
            ...
            <div class="mt-16">
                    ...
                    @if(App::getLocale() == 'ar')
                    <h2 class="flip" style="text-align: center">
                        <span class="text-gray-800 dark:text-gray-400" style="--i:1;font-family: 'Cairo', sans-serif;">تنا</span>
                        <span class="text-gray-800 dark:text-gray-400" style="--i:2;font-family: 'Cairo', sans-serif;">ما</span>
                        <span class="text-gray-800 dark:text-gray-400" style="--i:3;font-family: 'Cairo', sans-serif;">خد</span>
                    </h2>
                    @endif
                ...
                @if (App::getLocale() == 'ar')
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 " style="direction: rtl">
                        <a href="{{ route('sawaorder.new', 'Translation and Proofreading') }}"
                            ...
                            <div>
                                <div
                                    class=" bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                    <img class="card-img stroke-red-500" src="{{ asset('/imgs/services/trns.jpg') }}">
                                </div>
                        ...
                        <a href="{{ route('sawaorder.new', 'Teaching Arabic and Japanese') }}"
                            ...
                            <div>
                                <div
                                    class=" bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                    <img class="card-img stroke-red-500" src="{{ asset('/imgs/services/teach.jpg') }}">
                                </div>
                        ...
                        <a href="{{ route('sawaorder.new', 'Voice Recording and Transcription') }}"
                            ...
                            <div>
                                <div
                                    class=" bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                    <img class="card-img stroke-red-500" src="{{ asset('/imgs/voice.jpg') }}">
                                </div>
                        ...
                        <a href="{{ route('sawaorder.new', 'Adding Languages to Websites') }}"
                            ...
                            <div>
                                <div
                                    class=" bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                    <img class="card-img stroke-red-500" src="{{ asset('/imgs/services/addlang.jpg') }}">
                                </div>
                        ...
                        <a href="{{ route('sawaorder.new', 'Desktop Publishing (DTP)') }}"
                            ...
                            <div>
                                <div
                                    class=" bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                    <img class="card-img stroke-red-500" src="{{ asset('/imgs/services/dtp.jpg') }}">
                                </div>
                        ...
                        <a href="{{ route('sawaorder.new', 'Planning and Preparing News Reports') }}"
                            ...
                            <div>
                                <div
                                    class=" bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                    <img class="card-img stroke-red-500" src="{{ asset('/imgs/services/news.jpg') }}">
                                </div>
                        ...
                        <a href="{{ route('sawaorder.new', 'Design and Programming') }}"
                            ...
                            <div>
                                <div
                                    class=" bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                    <img class="card-img stroke-red-500" src="{{ asset('/imgs/services/designandprg.jpg') }}">
                                </div>
                        ...
                        <a href="{{ route('sawaorder.new', 'Tour planning') }}"
                            ...
                            <div>
                                <div
                                    class=" bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                    <img class="card-img stroke-red-500" src="{{ asset('/imgs/services/panning.jpg') }}">
                                </div>
                        ...
                        <a href="{{ route('sawaorder.new', 'Academic and Cultural Consultations') }}"
                            ...
                            <div>
                                <div
                                    class=" bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                    <img class="card-img stroke-red-500" src="{{ asset('/imgs/services/academic.jpg') }}">
                                </div>
                        ...
                        <a href="{{ route('sawaorder.new', 'Support for Scientific and Cultural') }}"
                            ...
                            <div>
                                <div
                                    class=" bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                    <img class="card-img stroke-red-500" src="{{ asset('/imgs/services/supsci.jpg') }}">
                                </div>
                        ...
                        <a href="{{ route('sawaorder.new', 'Investment and Business Consultations') }}"
                            ...
                            <div>
                                <div
                                    class=" bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                    <img class="card-img stroke-red-500" src="{{ asset('/imgs/services/invest.jpg') }}">
                                </div>
                        ...
                        <a href="{{ route('sawaorder.new', 'Import and Export') }}"
                            ...
                            <div>
                                <div
                                    class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                    <img class="card-img stroke-red-500" src="{{ asset('/imgs/services/export.png') }}">
                                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            <a href="{{ route('sawaorder.new', 'Translation and Proofreading') }}"
                                ...
                                <div>
                                    <div 
                                        class=" bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                        <img class="card-img stroke-red-500" class=" stroke-red-500" src="{{ asset('/imgs/services/trns.jpg') }}">
                                    </div>
                            ...
                            <a href="{{ route('sawaorder.new', 'Voice Recording and Transcription') }}"
                                ...
                                <div>
                                    <div
                                        class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center card-img-container">
                                        <img class="card-img stroke-red-500" src="{{ asset('/imgs/sawalogo.png') }}">
                                    </div>
        ...
        <div class="mt-4">
            @if (App::getLocale() == 'ar')
                <h2 class="waviy text-gray-400 dark:text-white" style="text-align: center;font-family: 'Cairo', sans-serif;">مجموعة سوا</h2>
            @else
            ...
            <img src="{{ asset('/imgs/sawalogo.png') }}" height="50px" width="auto" class="block rounded-full" style="margin: auto;margin-top: 127px;width:100px;height:auto">

                @if (App::getLocale() == 'ar')
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 " style="margin-top:6px;direction:rtl;">
                            ...
                            $.each(response, function(index, item) {
                                ...
                                if (item == 'en') {
                                    ...
                                    html += "<a href='{{ url('/lang') }}/" + item +
                                        ...
                                        "'></span></a>";
                                    mobhtml += "<li><a href='{{ url('/lang') }}/" + item +
                                    "' style='padding-top:6px;font-size:large;color:white;width:100%'>{{ __('website.en') }}<span class='langspan' style='display:inline-block;height:13px;background-image:" +
                                    " url({{ asset('/imgs/en.png') }})" +
                                    "'></span></a></li>";
                                } else if (item == 'ar') {
                                    html += "<a href='{{ url('/lang') }}/" + item +
                                        ...
                                        "'></span></a>";
                                    mobhtml += "<li><a href='{{ url('/lang') }}/" + item +
                                    "' style='padding-top:6px;font-size:x-large;color:white;width:100%'>{{ __('website.ar') }}<span class='langspan' style='display:inline-block;height:13px;background-image:" +
                                    " url({{ asset('/imgs/ar.png') }})" +
                                    "'></span></a></li>";
                                } else if (item == 'jp') {
                                    html += "<a href='{{ url('/lang') }}/" + item +
                                        ...
                                        "'></span></a>";
                                    mobhtml += "<li><a href='{{ url('/lang') }}/" + item +
                                    "' style='padding-top:6px;font-size:larger;color:white;width:100%'>{{ __('website.jp') }}<span class='langspan' style='display:inline-block;height:13px;background-image: " +
                                    "url({{ asset('/imgs/jp.png') }})" +
                                    "'></span></a></li>";
                                }
